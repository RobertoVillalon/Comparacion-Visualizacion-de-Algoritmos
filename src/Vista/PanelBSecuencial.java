...
public class PanelBSecuencial extends JPanel{
    ...
    private void IniciarPanel() {
        ...
        setBorder(new TitledBorder(new MetalBorders.PaletteBorder(),"Busqueda Secuencial"));
    ...
    private void IniciarPanelDatos(){
        labelComplejidad.setText("Complejidad: O(n²)");labelComplejidad.setHorizontalAlignment(JLabel.CENTER);
