...
public class PanelHeapSort extends JPanel{
    Controlador ctrl;
    ...
    public PanelHeapSort(Controlador ctrl){
        this.ctrl = ctrl;
        IniciarPanel();
        IniciarComponentes();
    }
    ...
    private void IniciarPanel() {
        ...
        setBorder(new TitledBorder(new MetalBorders.PaletteBorder(),"Heap-Sort"));
    ...
    private void IniciarPanelDatos(){
        complejidad.setText("Complejidad: Ω(n logn)");complejidad.setHorizontalAlignment(JLabel.CENTER);
