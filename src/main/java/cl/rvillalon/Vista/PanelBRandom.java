...
public class PanelBRandom extends JPanel{
    ...
    private void IniciarPanel() {
        ...
        setBorder(new TitledBorder(new MetalBorders.PaletteBorder(),"Busqueda Random"));
    ...
    private void IniciarPanelDatos(){
        labelComplejidad.setText("Complejidad: No Posee");labelComplejidad.setHorizontalAlignment(JLabel.CENTER);
